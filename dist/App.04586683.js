...
},{"./cjs/react-dom.development.js":"../node_modules/react-dom/cjs/react-dom.development.js"}],"AgeCounter.tsx":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  AgeCounter.prototype.render = function () {
    var _this = this;
    ...
    return React.createElement("div", {
      ...
      onClick: function onClick(e) {
        return _this.props.updateAge(1);
      }
    }, "inc"), React.createElement("button", {
      onClick: function onClick(e) {
        return _this.props.updateAge(-1);
      }
    }, "dec")), "Age: ", this.props.age, React.createElement("br", null));
  };
...
},{"react":"../node_modules/react/index.js"}],"AdvancedAgeCounter.tsx":[function(require,module,exports) {
"use strict";
...
var AdvancedAgeCounter =
/** @class */
function (_super) {
  __extends(AdvancedAgeCounter, _super);

  function AdvancedAgeCounter(props) {
    var _this = _super.call(this, props) || this;
    /*         this.handleAgeCounterInc = this.handleAgeCounterInc.bind(this)
            this.handleAgeCounterDec = this.handleAgeCounterDec.bind(this) */
    ...
    _this.state = {
      updatedCycleAge: props.age
    };
    return _this;
  }

  AdvancedAgeCounter.prototype.componentWillUnmount = function () {
    console.log("I am off and my life cycle is closed");
  };

  AdvancedAgeCounter.prototype.componentDidMount = function () {
    console.log("I am on and my life cyle is started after the render");
  };

  AdvancedAgeCounter.prototype.componentWillReceiveProps = function (nextProps) {
    console.log("Happy birthday . Your new age is: " + nextProps.age);
  };

  AdvancedAgeCounter.prototype.componentWillMount = function () {
    var _this = this;

    console.log("component mounted");
    var count = 3;

    var my_custom_timeout = function my_custom_timeout() {
      return setTimeout(function () {
        if (count <= 0) {
          ...
          _this.setState(__assign({}, _this.state, {
            updatedCycleAge: count + _this.props.age
          }));
    ...
    my_custom_timeout(); //setInterval(() => console.log("Hello interval"), 3000) // :(
  };

  AdvancedAgeCounter.prototype.render = function () {
    var _this = this;
  ...
  return AdvancedAgeCounter;
}(React.Component);

exports["default"] = AdvancedAgeCounter;
},{"react":"../node_modules/react/index.js"}],"Iscrizione.tsx":[function(require,module,exports) {
"use strict";
...
var AgeCounter_1 = __importDefault(require("./AgeCounter"));

var AdvancedAgeCounter_1 = __importDefault(require("./AdvancedAgeCounter"));

var Iscrizione =
/** @class */
function (_super) {
  __extends(Iscrizione, _super);

  function Iscrizione(props, context) {
  ...
  Iscrizione.prototype.componentDidMount = function () {
    ...
    var my_custom_timeout = function my_custom_timeout() {
      return setTimeout(function () {
        if (_this.state.age > 100) {
          console.log("Bye bye out.");
          return;
        } else {
          console.log("Hello my age now is ", _this.state.age);

          _this.setState(__assign({}, _this.state, {
            age: _this.state.age + 1
          }), function () {
            return my_custom_timeout();
          }); //Avoids overlapping of setstate and is safer
  ...
  Iscrizione.prototype.render = function () {
    var _this = this;

    return React.createElement("div", {
      className: "container"
    }, React.createElement("div", null, "PARENTS DETAILS"), "First name: ", React.createElement("input", {
      type: "text",
    ...
    }), " ", React.createElement("br", null), "Mothers surname: ", this.props.cognome, React.createElement("br", null), "Age: ", this.state.age, React.createElement("br", null), "BSN: ", this.props.bsn, React.createElement("br", null), React.createElement("div", {
      className: "radio"
    ...
    }), "Male")), React.createElement("br", null), React.createElement("div", {
      className: "radio"
    }, React.createElement("label", null, React.createElement("input", {
      type: "radio",
      ...
      onClick: function onClick(e) {
        return _this.setState(__assign({}, _this.state, {
          showStato: _this.state.showStato == "show" ? 'collapse' : 'show'
        }));
      }
    }, this.state.showStato == 'collapse' ? 'show' : 'collapse'), this.state.showStato == "show" ? React.createElement("div", null, React.createElement("table", null, React.createElement("tr", null, React.createElement("td", null, "Nome ", this.state.nome)), React.createElement("tr", null, React.createElement("td", null, "Cognome ", this.state.cognome)), React.createElement("tr", null, React.createElement("td", null, "Bsn ", this.state.bsn)), React.createElement("tr", null, React.createElement("td", null, "Sex ", this.state.sex))), React.createElement(AgeCounter_1.default, {
      updateAge: this.updateAge,
      age: this.state.age
    }), React.createElement(AdvancedAgeCounter_1.default, {
      updateAge: this.updateAge,
      age: this.state.age
    })) : null);
  };
...
exports["default"] = Iscrizione;
},{"react":"../node_modules/react/index.js","./AgeCounter":"AgeCounter.tsx","./AdvancedAgeCounter":"AdvancedAgeCounter.tsx"}],"App.tsx":[function(require,module,exports) {
"use strict";
...
var Iscrizione_1 = __importDefault(require("./Iscrizione"));
/* render(<Counter text={"Fatima Abbadi"}/>, document.getElementById('main')); */


react_dom_1.render(React.createElement(Iscrizione_1.default, {
  nome: "Fatima",
  cognome: "Abbadi",
  bsn: 1234555,
  sex: "female"
}), document.getElementById('main'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","./Iscrizione":"Iscrizione.tsx"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
